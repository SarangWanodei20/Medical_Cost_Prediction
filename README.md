Medical Cost Prediction Analysis By POWER BI
...
Health Analysis: Diabetes, Hypertension, Heart Disease & Asthma
Lifestyle Analysis: Daily Steps, Sleep Hours, Stress Level

Patient Expense Analysis
Insurance Coverage Analysis
Previous Year vs Annual Medical Cost Comparison
Predictive Healthcare Cost Insights
Project Learnings
Creation of interactive healthcare dashboards
Data cleaning and transformation using Power Query

Use of aggregation functions like :- SUM, AVERAGE, MIN, MAX, and COUNT

DAX calculations and KPI generation
Data visualization using charts, graphs, KPI cards, slicers, and filters
